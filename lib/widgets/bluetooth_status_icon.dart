        ...
        return Consumer<BluetoothProvider>(
          builder: (context, bluetoothProvider, child) {
            ...
            if (!hasPermission) {
              ...
              bluetoothIconColor = colors.accentOrange;
              bluetoothIcon = Icons.bluetooth_disabled;
              signalIconColor = colors.textMuted;
              signalIcon = Icons.signal_cellular_off;
            } else if (isOn) {
              if (isConnected) {
                // 蓝牙开启且已连接设备
                bluetoothIconColor = colors.accentGreen;
                bluetoothIcon = Icons.bluetooth_connected;
                // 已连接显示满格信号
                signalIconColor = colors.accentGreen;
                signalIcon = Icons.signal_cellular_alt;
              } else {
                // 蓝牙开启但未连接设备
                bluetoothIconColor = colors.primary;
              ...
              // 蓝牙关闭 - 显示关闭图标，信号无连接
              bluetoothIconColor = colors.textMuted;
              bluetoothIcon = Icons.bluetooth_disabled;
              signalIconColor = colors.textMuted;
              signalIcon = Icons.signal_cellular_off;
            }
